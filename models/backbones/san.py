#Resnet SAN from paper: https://hszhao.github.io/papers/cvpr20_san.pdf
"""
The below code is modified from the official implementation of SAN:https://github.com/hszhao/SAN 
"""
import torch
...
def san(sa_type, layers, kernels, num_classes):
    ...
    #TODO: control the last layer channels to be integrated with the feature aggregators
