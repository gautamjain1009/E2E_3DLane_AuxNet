"""
adopted from https://github.com/Turoad/lanedet/blob/main/lanedet/datasets/process/transforms.py
"""
import random
import cv2
import numpy as np
...
class Resize(object):
    def __init__(self, size, cfg=None):
        ...
        self.size = size
        assert (isinstance(self.size, collections.Iterable) and len(self.size) == 2)
